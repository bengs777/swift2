...
export function getProductionReadiness() {
  const checks: ReadinessCheck[] = [
    ...
    check("OPENAI_API_KEY", "Swift AI provider key", env.openAiApiKey, "required", "Swift AI is routed through the OpenAI-compatible provider."),
    check("OPENAI_API_URL", "Swift AI provider base URL", env.openAiApiUrl, "required"),
